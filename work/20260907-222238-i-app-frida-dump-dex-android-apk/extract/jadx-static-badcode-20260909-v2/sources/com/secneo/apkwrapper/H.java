...
public class H {
    ...
    public static String PKGNAME = "com.moutai.mall";
    public static String b = "com.moutai.mall.MTApp";
    ...
    public static String PC_FLAG = "0";
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static Object a(Class<?> cls, Object obj, Object[] objArr, String str, Class<?>... clsArr) {
        try {
            int[] iArr = new int[0];
            try {
    ...
    */
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static void callBS(Context context) {
        try {
            int[] iArr = new int[0];
            try {
