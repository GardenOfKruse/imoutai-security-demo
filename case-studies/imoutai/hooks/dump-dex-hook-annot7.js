...
`;
  ...
  // entry-annot7.js
  var require_entry_annot7 = __commonJS({
    "entry-annot7.js"() {
      ...
      function install() {
        frida_java_bridge_default.perform(function() {
          ...
          safe(function() {
            ...
            const cls = CU.class;
            const names = cls.getDeclaredMethods().map(function(m) {
                ...
                CU[mn].overloads.forEach(function(ov) {
                  ov.implementation = function() {
                    ...
                    if (capturing) {
                      ...
                      rec.ret = safe(function() {
                        return String(r);
                      }, "ret");
                      if (rec.ret === void 0) rec.ret = "(bytes?)";
          ...
          safe(function() {
            const w = frida_java_bridge_default.use("com.moutai.mall.api.model.GetVerifyCodeRequest");
            w.$init.overloads.forEach(function(ov) {
              ...
              ov.implementation = function() {
                ...
                send({ type: "ctor", cls: "GetVerifyCodeRequest", args });
                return ov.apply(this, arguments);
              };
            });
          }, "ctor");
