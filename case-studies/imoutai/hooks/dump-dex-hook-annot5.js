...
`;
  ...
  // entry-annot5.js
  var require_entry_annot5 = __commonJS({
    "entry-annot5.js"() {
      ...
      var samples = { vcode: [], headers: [] };
      function readFields(obj, names) {
        const out = {};
        names.forEach(function(n) {
          out[n] = safe(function() {
            return String(obj[n].value);
          }, "f:" + n);
        });
        return out;
      }
      ...
      rpc.exports = {
        ...
        sampleStaticHeaders: function() {
          ...
          frida_java_bridge_default.perform(function() {
            ...
            safe(function() {
              const aa = frida_java_bridge_default.use("com.moutai.mall.api.a$a");
              out["a$a.invoke"] = safe(function() {
                return String(aa.invoke());
              }, "aa");
            }, "a$a");
            safe(function() {
        ...
        getStats: function() {
          return { agent: "annot5", vcode: samples.vcode.length };
        }
      };
      setImmediate(install);
    }
  });
  require_entry_annot5();
})();
