...
`;
  ...
  // entry-final.js
  var require_entry_final = __commonJS({
    "entry-final.js"() {
      ...
      function shortStack() {
        return safe(function() {
          const s = frida_java_bridge_default.use("android.util.Log").getStackTraceString(frida_java_bridge_default.use("java.lang.Exception").$new());
      ...
      function install() {
        frida_java_bridge_default.perform(function() {
          ...
          [
            ...
            safe(function() {
              const w = frida_java_bridge_default.use(cn);
          ...
          safe(function() {
            const MD = frida_java_bridge_default.use("java.security.MessageDigest");
          ...
          safe(function() {
            const CU = frida_java_bridge_default.use("com.netease.libs.yxsecurity.encrypt.CryptoUtil");
            const names = CU.class.getDeclaredMethods().map(function(m) {
          ...
          safe(function() {
            ...
            const names = frida_java_bridge_default.enumerateLoadedClassesSync().filter(function(x) {
              return x.indexOf(PKG) === 0;
            });
            ...
            for (let i = 0; i < names.length; i++) {
              try {
                const cls = frida_java_bridge_default.use(names[i]).class;
                const methods = [];
                ...
                for (let j = 0; j < declared.length; j++) {
                  ...
                  try {
                    const a = m.getDeclaredAnnotations();
                    for (let k = 0; k < a.length; k++) item.annotations.push(String(a[k]));
                  } catch (e1) {
                    item.annotations.push("(ann failed: " + e1 + ")");
                  }
                  try {
                    ...
                    item.parameterAnnotations.push(["(paramann failed: " + e2 + ")"]);
                  }
                  methods.push(item);
                }
                const fields = [];
                try {
                  ...
                  for (let j = 0; j < fs.length; j++) {
                    ...
                    try {
                      const a = f.getDeclaredAnnotations();
                      for (let k = 0; k < a.length; k++) item.annotations.push(String(a[k]));
                    } catch (e) {
                      item.annotations.push("(ann failed: " + e + ")");
                    }
                    fields.push(item);
                  }
                } catch (e) {
                ...
                send({ type: "reflection", className: names[i], methods, fields });
                dumped++;
              } catch (e) {
                failed++;
      ...
      rpc.exports = {
        getStats: function() {
          return { agent: "final-hook", capturing, capturedLen: captured.length };
        },
          ...
          frida_java_bridge_default.perform(function() {
            safe(function() {
              ...
              ["b", "c", "d"].forEach(function(mn) {
                out["api.a." + mn] = safe(function() {
                  return String(a[mn]());
                }, "a." + mn);
              });
            }, "a-static");
            safe(function() {
              frida_java_bridge_default.choose("com.moutai.mall.api.a$b", {
                onMatch: function(inst) {
                  ["a", "b", "c", "d"].forEach(function(mn) {
                    out["a$b." + mn] = safe(function() {
                      return String(inst[mn]());
                    }, "ab." + mn);
                  });
                },
                onComplete: function() {
        ...
        sampleVcode: function(mobile) {
          let result = null;
          frida_java_bridge_default.perform(function() {
            frida_java_bridge_default.choose("com.moutai.mall.module.login.LoginActivity", {
              onMatch: function(inst) {
                safe(function() {
                  captured = [];
                  capturing = true;
                  const reqObj = inst.getVerifyRequest(frida_java_bridge_default.use("java.lang.String").$new(String(mobile)));
                  capturing = false;
                  const triple = {};
                  ["mobile", "timestamp", "md5"].forEach(function(n) {
                    triple[n] = safe(function() {
                      return String(reqObj[n].value);
                    }, "f:" + n);
                  });
            ...
            safe(function() {
              ...
              for (let i = 0; i < fs.length; i++) {
                (function(f) {
                  ...
                  out[name] = isStatic ? safe(function() {
                    return String(f.get(null));
                  }, name) : "(instance:" + f.getType() + ")";
                })(fs[i]);
              }
              const inst = safe(function() {
                return CU.j();
              }, "j");
              ["getPrivateKey"].forEach(function(mn) {
                out["fn:" + mn] = safe(function() {
                  return String(CU[mn]()).substring(0, 200);
                }, mn);
              });
            }, "probe");
          });
