...
`;
  ...
  // entry-annot4.js
  var require_entry_annot4 = __commonJS({
    "entry-annot4.js"() {
      ...
      function install() {
        frida_java_bridge_default.perform(function() {
          ...
          safe(function() {
            ...
            const out = {};
            for (let i = 0; i < vals.length; i++) out[String(vals[i].name())] = safe(function() {
              return String(vals[i].getApp());
            }, "ep");
      ...
      rpc.exports = {
        getStats: function() {
          return { ok: true, agent: "annot4" };
        }
      };
    }
  });
  require_entry_annot4();
})();
