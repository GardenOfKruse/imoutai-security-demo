        ...
        try {
          Process.setExceptionHandler(function(details) {
            try {
              ...
              var range = null;
              try {
                range = Process.findRangeByAddress(ptr(details.address));
              } catch (e) {
              }
              log("X: native exception type=" + details.type + " address=" + details.address + " pc=" + pc + " x0=" + x0 + " range=" + (range ? JSON.stringify({
