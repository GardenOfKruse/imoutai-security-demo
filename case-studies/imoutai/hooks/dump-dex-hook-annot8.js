...
`;
  ...
  // entry-annot8.js
  var require_entry_annot8 = __commonJS({
    "entry-annot8.js"() {
          ...
          frida_java_bridge_default.perform(function() {
            safe(function() {
              ...
              ["j", "getSeed", "getPrivateKey", "a", "b", "d", "e", "f", "g", "h", "i", "k", "m", "n"].forEach(function(mn) {
                safe(function() {
                  const ov = CU[mn].overloads.filter(function(o) {
                    return o.argumentTypes.length === 0;
                  })[0];
                  if (!ov) {
                    out["fn:" + mn] = "(needs args)";
                    return;
                  }
                  ...
                  const rs = safe(function() {
                    return String(r);
                  }, "r");
                  out["fn:" + mn + "()"] = rs !== void 0 ? rs.substring(0, 200) : "(bytes/null)";
                }, "probe:" + mn);
              });
            }, "probe");
          });
