(() => {
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/alloc.js
  function abs(nptr) {
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/result.js
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/jvmti.js
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/machine-code.js
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/memoize.js
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/env.js
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/vm.js
  function VM(api2) {
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/android.js
  var android_exports = {};
...
`, {
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/jvm.js
  function getApi2() {
    if (cachedApi2 === null) {
      cachedApi2 = _getApi2();
    }
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/api.js
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/class-model.js
...
`;
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/lru.js
  var LRU;
  var init_lru = __esm({
    "android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/lru.js"() {
      LRU = class {
  ...
  // android/case-studies/imoutai/hooks/_build/buffer-shim.js
  function utf8Bytes(s) {
    ...
    for (var i = 0; i < s.length; i++) {
      ...
      if (c < 128) out.push(c);
        ...
        var cp = 65536 + (c - 55296 << 10) + (d - 56320);
        out.push(
          240 | cp >> 18,
          128 | cp >> 12 & 63,
          128 | cp >> 6 & 63,
      ...
      BufferShim = class _BufferShim extends Uint8Array {
        static from(value, encoding) {
          if (typeof value === "string") {
            ...
            return new _BufferShim(utf8Bytes(value));
          }
          if (value instanceof ArrayBuffer) return new _BufferShim(new Uint8Array(value));
          if (ArrayBuffer.isView(value)) return new _BufferShim(value);
          return new _BufferShim(value || []);
        }
        static alloc(size) {
        ...
        static concat(list, totalLength) {
          ...
          var out = new _BufferShim(totalLength);
          var off = 0;
        ...
        write(str, offset, length, encoding) {
          offset = offset || 0;
          var bytes = _BufferShim.from(str, encoding);
          var n = Math.min(length === void 0 ? bytes.length : length, bytes.length, this.length - offset);
        ...
        copy(target, targetStart, sourceStart, sourceEnd) {
          ...
          sourceEnd = sourceEnd === void 0 ? this.length : sourceEnd;
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/mkdex.js
  function mkdex(spec) {
  ...
  var init_mkdex = __esm({
    "android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/mkdex.js"() {
      ...
      kDefaultConstructorDebugInfo = BufferShim.from([3, 0, 7, 14, 0]);
      kDalvikAnnotationTypeThrows = "Ldalvik/annotation/Throws;";
      kNullTerminator = BufferShim.from([0]);
      DexBuilder = class {
        constructor() {
          this.classes = [];
        }
        ...
        build() {
          ...
          const stringOffsets = strings.map((str) => {
            ...
            const header = BufferShim.from(createUleb128(str.length));
            const data = BufferShim.from(str, "utf8");
            const chunk = BufferShim.concat([header, data, kNullTerminator]);
          ...
          const dex = BufferShim.alloc(fileSize);
          dex.write("dex\n035");
          ...
          BufferShim.from(hash.getDigest()).copy(dex, signatureOffset);
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/types.js
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/lib/class-factory.js
  ...
  // android/case-studies/imoutai/hooks/_build/node_modules/frida-java-bridge/index.js
  ...
  // android/case-studies/imoutai/hooks/dump-dex-hook.js
  function log(s) {
    console.log("[dexhook] " + s);
  }
  ...
  function install_getenv_observer(vm3) {
    if (getenv_observer_installed || !vm3) return;
    try {
      var table = ptr(vm3).readPointer();
      var getEnv = table.add(Process.pointerSize * 7).readPointer();
      Interceptor.attach(getEnv, {
        ...
        onLeave: function(retval) {
          ...
          var range = null;
          try {
            env = this.out.readPointer();
          } catch (e) {
          }
          try {
            if (env) range = Process.findRangeByAddress(env);
          } catch (e) {
          }
          log("X: GetEnv ret=" + retval + " env=" + env + " envRange=" + (range ? JSON.stringify({
      ...
      log("X: GetEnv observer unavailable=" + e);
    }
  }
    ...
    for (var t = 0; t < targets.length; t++) {
      ...
      for (var i = 0; i + needle.length <= length; i++) {
        ...
        for (var j = 0; j < needle.length; j++) {
          ...
          if (lo !== needle.charCodeAt(j)) {
            ok = false;
            break;
          }
        }
        if (!ok) continue;
        for (var k = 0; k < needle.length; k++) buf.add(i + k).writeU8(120);
        changed++;
        i += needle.length - 1;
      }
    }
  ...
  function install_maps_filter() {
    ...
    if (!openat || !read) {
      log("T3: maps filter unavailable (openat/read missing)");
      return false;
    }
  ...
  function find_app_loader() {
    ...
    var probed = 0;
    try {
      var loaders = frida_java_bridge_default.enumerateClassLoadersSync();
      for (var i = 0; i < loaders.length && !app_loader; i++) {
        ...
        try {
          ...
          probed++;
          l.loadClass("com.secneo.apkwrapper.H");
          app_loader = l;
        } catch (e) {
        }
      }
  ...
  function env_clear_exc(e) {
    var fn = e.readPointer().add(Process.pointerSize * 17).readPointer();
    new NativeFunction(fn, "void", ["pointer"])(e);
  }
  function jbytearray_to_arraybuffer(jarr) {
    var N = jarr.length;
    var ByteBuffer = frida_java_bridge_default.use("java.nio.ByteBuffer");
  ...
  function jbuffer_to_arraybuffer(buf) {
    ...
    if (addr !== null && !addr.isNull() && !ptr(0).equals(ptr(addr))) {
      return ptr(addr).add(dup.position()).readByteArray(N);
    }
    try {
      return jbytearray_to_arraybuffer(dup.array());
    } catch (e) {
      var out = new ArrayBuffer(N);
      var u8 = new Uint8Array(out);
      for (var i = 0; i < N; i++) u8[i] = dup.get() & 255;
      return out;
    }
  }
  function short_stack() {
    try {
      return frida_java_bridge_default.use("android.util.Log").getStackTraceString(
        frida_java_bridge_default.use("java.lang.Exception").$new()
      ).split("\n").slice(0, 25).join("\n");
    } catch (e) {
      return "(no stack)";
    }
  ...
  function send_dex(ab, meta) {
    ...
    var magicOk = u8[0] === 100 && u8[1] === 101 && u8[2] === 120 && u8[3] === 10;
    log("C: \u6355\u83B7\u7F13\u51B2 #" + stats.dex_captured + " size=" + ab.byteLength + " magic=" + magicOk + " src=" + meta.src);
  ...
  function install_java_hooks() {
    ...
    try {
      var System = frida_java_bridge_default.use("java.lang.System");
      System.exit.overload("int").implementation = function(code2) {
        stats.exit_blocked++;
        log("B: System.exit(" + code2 + ") \u5DF2\u963B\u65AD #" + stats.exit_blocked + "\n" + short_stack());
        return;
      };
    } catch (e) {
      log("B: System.exit hook fail: " + e);
    }
    try {
      var Runtime2 = frida_java_bridge_default.use("java.lang.Runtime");
      ["exit", "halt"].forEach(function(m) {
        Runtime2[m].overload("int").implementation = function(code2) {
          stats.exit_blocked++;
          log("B: Runtime." + m + "(" + code2 + ") \u5DF2\u963B\u65AD\n" + short_stack());
          return;
        };
      });
    } catch (e) {
      log("B: Runtime hook fail: " + e);
    }
    try {
      var Proc = frida_java_bridge_default.use("android.os.Process");
      ...
      log("B: Process.killProcess hook fail: " + e);
    }
    try {
      var System = frida_java_bridge_default.use("java.lang.System");
      ["load", "loadLibrary"].forEach(function(mn) {
        System[mn].overloads.forEach(function(ov) {
          ov.implementation = function() {
            try {
              log("B2: System." + mn + "(" + String(arguments[0]) + ")");
            } catch (e) {
            }
      ...
      log("B2: System.load hook fail: " + e);
    }
    try {
      var Runtime22 = frida_java_bridge_default.use("java.lang.Runtime");
      ["load", "loadLibrary", "nativeLoad"].forEach(function(mn) {
        var ovs;
        try {
          ovs = Runtime22[mn].overloads;
        } catch (e) {
          return;
        }
        ovs.forEach(function(ov) {
          ov.implementation = function() {
            try {
              ...
              if (mn === "nativeLoad" && native_redirect_path && a0.indexOf("libDexHelper.so") !== -1 && a0.indexOf("/") === -1) {
                ...
                try {
                  ...
                  for (var c = arguments.length - 1; c > 0; c--) {
                    var cc = arguments[c];
                    if (cc && cc.$className === "java.lang.Class") {
                      callerCls = cc;
                      break;
                    }
                  }
                  if (callerCls) {
                    ...
                    if (cl) {
                      cl.loadClass("com.secneo.apkwrapper.H");
                      ld = cl;
            ...
            try {
              ...
              if (mn === "nativeLoad") {
                if (ret === null || ret === void 0) {
                  ...
                  log("B2: Runtime.nativeLoad result=error[len=" + diag.length + ",tail=" + tail + "]");
                }
              }
              return ret;
            } catch (e) {
      ...
      log("B2: Runtime load hook fail: " + e);
    }
    try {
      var MiuiForceDark = frida_java_bridge_default.use("android.graphics.MiuiForceDarkConfigManagerImpl");
      ...
      forceDarkMethods.forEach(function(methodName) {
        try {
          ...
          MiuiForceDark[methodName].overloads.forEach(function(ov) {
            ov.implementation = function() {
              try {
                log("B3: MiuiForceDarkConfigManagerImpl." + methodName + " bypassed");
              } catch (e) {
              }
              return ov.returnType && ov.returnType.type === "void" ? void 0 : 0;
            };
            forceDarkHooked++;
          });
        } catch (e) {
      ...
      log("B3: MiuiForceDarkConfigManagerImpl hook fail: " + e);
    }
    try {
      var ThreadCls = frida_java_bridge_default.use("java.lang.Thread");
      ThreadCls.setDefaultUncaughtExceptionHandler.overload(
        "java.lang.Thread$UncaughtExceptionHandler"
      ).implementation = function(h) {
        try {
          log("B4: setDefaultUncaughtExceptionHandler <- " + (h === null ? "null" : h.getClass().getName()));
        } catch (e) {
        }
      ...
      log("B4: UEH hook fail: " + e);
    }
    try {
      var env = frida_java_bridge_default.vm.getEnv();
      var vtable2 = env.handle.readPointer();
      var regNat = vtable2.add(215 * Process.pointerSize).readPointer();
      Interceptor.attach(regNat, {
        onEnter: function(args) {
          ...
          try {
            ...
            recs.push("(read fail: " + e + ")");
          }
          log("E1: RegisterNatives #" + stats.regnat_count + " count=" + count + " caller=" + (caller ? caller.name : "?") + " " + recs.join(" | "));
          send({
            type: "regnat",
            seq: stats.regnat_count,
            count,
      ...
      log("E1: RegisterNatives hook fail: " + e);
    }
    var lastClassCount = "";
    setInterval(function() {
      frida_java_bridge_default.perform(function() {
        try {
          var all = frida_java_bridge_default.enumerateLoadedClassesSync();
          var app = 0;
    ...
    log("E2: \u7C7B\u52A0\u8F7D\u65F6\u95F4\u7EBF\u5DF2\u88C5 (3s)");
    try {
      var IMDCL = frida_java_bridge_default.use("dalvik.system.InMemoryDexClassLoader");
      ...
      log("C1: IMDCL hook fail: " + e);
    }
    try {
      var DexFile2 = frida_java_bridge_default.use("dalvik.system.DexFile");
      ["openInMemoryDexFile", "openInMemoryDexFiles", "loadDex", "openDexFile"].forEach(function(mn) {
        var ovList;
        try {
          ovList = DexFile2[mn].overloads;
        } catch (e) {
          return;
        }
      ...
      log("C2: DexFile hook fail: " + e);
    }
    try {
      var DCL = frida_java_bridge_default.use("dalvik.system.DexClassLoader");
  ...
  function build_ranges() {
    ...
    for (var p = 0; p < prots.length; p++) {
      ...
      for (var i = 0; i < rs.length; i++) {
        ...
        if (r.file) {
          var fp = r.file.path || "";
          if (fp.indexOf("/memfd:") !== 0 && fp.indexOf("/data/user/0/com.moutai.mall") !== 0 && fp.indexOf("/data/data/com.moutai.mall") !== 0) continue;
        }
        if (r.size > 1024 * 1024 * 1024) continue;
        if (r.size < 128) continue;
        ranges.push(r);
      }
    }
    return ranges;
  ...
  function scan_dexes() {
    ...
    for (var i = 0; i < ranges.length; i++) {
      ...
      var matches;
      try {
        matches = Memory.scanSync(r.base, r.size, "64 65 78 0a");
      } catch (e) {
        continue;
      }
      for (var m = 0; m < matches.length; m++) {
        try {
          ...
          var size = base.add(32).readU32();
          var header_size = base.add(36).readU32();
          var endian = base.add(40).readU32();
          var map_off = base.add(52).readU32();
          if (header_size !== 112 || endian !== 305419896) continue;
          if (size < 112 || size > 200 * 1024 * 1024) continue;
          if (map_off < 112 || map_off >= size) continue;
          if (!in_ranges(ranges, base, base.add(size))) continue;
          var key = base.toString() + "_" + size;
          if (found[key]) continue;
          found[key] = { base: base.toString(), size, protection: r.protection, map_off };
    ...
    try {
      ...
      for (var i = 0; i < ds.length; i++) {
        ...
        try {
          ...
          log("D2: live read fail " + key + ": " + e);
        }
      }
    } catch (e) {
      log("D2: live scan fail: " + e);
    }
    live_scanning = false;
  }
  ...
  function preload_native_no_jni(path) {
    try {
      ...
      var handle = callDlopen(Memory.allocUtf8String(String(path)), 2);
  ...
  var SHELL_SOS, stats, native_redirect_path, app_loader, maps_filter_enabled, maps_filter_fds, maps_filter_streams, attach_jni_onload_observer, getenv_observer_installed, stage_entry_observer_installed, stage_entry_observer_address, findclass_gate, findclass_in_fallback, fc_orig, fc_loader_wrapper, stats_fc, live_emitted, live_scanning, live_scan_enabled;
  var init_dump_dex_hook = __esm({
    "android/case-studies/imoutai/hooks/dump-dex-hook.js"() {
      ...
      stats = { pthread_total: 0, pthread_suppressed: 0, modules: {}, dex_captured: 0, exit_blocked: 0, native_signal_blocked: 0, regnat_count: 0, jni_onload_observed: 0, jni_findclass_calls: 0, jni_findclass_null: 0 };
      native_redirect_path = null;
      app_loader = null;
      maps_filter_enabled = false;
      maps_filter_fds = {};
      maps_filter_streams = {};
      attach_jni_onload_observer = null;
      getenv_observer_installed = false;
      stage_entry_observer_installed = false;
      stage_entry_observer_address = null;
      (function install_exception_observer() {
        try {
          Process.setExceptionHandler(function(details) {
            try {
              let rangeSummary = function(r) {
                return r ? {
              ...
              try {
                x0Range = Process.findRangeByAddress(ptr(x0));
              } catch (e) {
              }
              log("X: native exception type=" + details.type + " address=" + details.address + " pc=" + pc + " x0=" + x0 + " memory=" + JSON.stringify(details.memory || null) + " pcRange=" + JSON.stringify(rangeSummary(pcRange)) + " faultRange=" + JSON.stringify(rangeSummary(faultRange)) + " x0Range=" + JSON.stringify(rangeSummary(x0Range)));
              try {
                log("X: backtrace\n" + Thread.backtrace(ctx, Backtracer.ACCURATE).slice(0, 12).map(describe_native_address).join("\n"));
              } catch (e) {
              }
            } catch (e) {
              log("X: exception observer error=" + e);
            }
            return false;
          });
          log("X: native exception observer installed");
        } catch (e) {
          log("X: native exception observer unavailable=" + e);
        }
      })();
      (function install_protection_observer() {
        try {
          ...
          if (mprotect) {
            Interceptor.attach(mprotect, {
              onEnter: function(args) {
                this.watch = (args[2].toInt32() & 7) === 0;
                if (this.watch) {
                  log("X: mprotect PROT_NONE addr=" + args[0] + " len=" + args[1] + " caller=" + this.returnAddress);
                }
              },
              onLeave: function(retval) {
          ...
          log("X: protection observer unavailable=" + e);
        }
      })();
      (function() {
        ...
        var inert_thread = new NativeCallback(function(arg) {
          return ptr(0);
        }, "pointer", ["pointer"]);
      ...
      fc_orig = null;
      fc_loader_wrapper = null;
      stats_fc = { calls: 0, nulls: 0, fixed: 0, cleared: 0 };
      (function install_global_findclass_fix() {
        frida_java_bridge_default.perform(function() {
          try {
            var env = frida_java_bridge_default.vm.getEnv();
            ...
            var fix = new NativeCallback(function(e, namePtr) {
              ...
              try {
                ...
                frida_java_bridge_default.performNow(function() {
                  try {
                    if (!fc_loader_wrapper) fc_loader_wrapper = find_app_loader();
                    if (!fc_loader_wrapper) return;
                    var dot = name.replace(/\//g, ".");
                    var cls = fc_loader_wrapper.loadClass.overload("java.lang.String").call(fc_loader_wrapper, dot);
          ...
          try {
            ...
            log("A5: maps filter auto-install skip: " + err);
          }
        });
      })();
      (function() {
        try {
          ...
          if (!libart) {
            log("A5b: libart not found");
            return;
          }
          var entry = libart.base.add("0x465E60");
          var head = entry.readU32();
          var okPrologue = head === 3573752639 || // paciasp
          head >>> 24 === 169 || // stp x.. , [sp,#-..]!
          head >>> 24 === 209;
          if (!okPrologue) {
          ...
          Interceptor.attach(entry, {
            ...
            onLeave: function(retval) {
              ...
              var name = "";
              try {
                name = this.np.readCString();
              } catch (err) {
                return;
              }
              stats_fc.nulls++;
              try {
                env_clear_exc(this.e);
              } catch (err) {
              }
              var fixedHandle = null;
              try {
      ...
      (function() {
        ...
        function attach_onload(address, source) {
          ...
          try {
            var actualStageEntry = stable.sub(84100).add(123708);
            ...
            if (stage_entry_observer_address !== actualStageKey) {
              Interceptor.attach(actualStageEntry, {
                onEnter: function(args) {
                  ...
                  var range = null;
                  try {
                    range = Process.findRangeByAddress(env);
                  } catch (e) {
                  }
                  log("X: actual sub_1E33C enter env=" + env + " envRange=" + (range ? JSON.stringify({
                    base: range.base.toString(),
                    size: range.size,
                    protection: range.protection,
                    file: range.file ? range.file.path : null
            ...
            log("A5: JNI_OnLoad attach fail: " + e);
          }
        }
            ...
            onAdded: function(module) {
              ...
              try {
                if (!stage_entry_observer_installed) {
                  var stageEntry = module.base.add(123708);
                  Interceptor.attach(stageEntry, {
                    onEnter: function(args) {
                      ...
                      log("X: sub_1E33C enter env=" + env + " envRange=" + (range ? JSON.stringify({
                        base: range.base.toString(),
                        size: range.size,
                        protection: range.protection,
                        file: range.file ? range.file.path : null
                ...
                log("A5: module export scan fail: " + e);
              }
            }
          });
          log("A5: module observer installed");
        } catch (e) {
          log("A5: module observer unavailable: " + e);
        }
      ...
      (function() {
        ...
        stub.writeU32(2854159328);
        stub.add(4).writeU32(3596551104);
          ...
          try {
            Interceptor.attach(addr, {
              onEnter: function(args) {
                ...
                log("A2: " + name + (sig === null ? "" : "(" + sig + ")") + " caller=" + callerName + " @" + describe_native_address(this.returnAddress) + (this.block ? " [BLOCKED]" : ""));
                if (name === "abort" || name === "__stack_chk_fail") {
                  try {
                    var bt = Thread.backtrace(this.context, Backtracer.ACCURATE).slice(0, 12).map(describe_native_address).join("\n");
                    log("A2: " + name + " backtrace:\n" + bt);
                  } catch (e) {
                    log("A2: backtrace unavailable " + e);
                  }
                }
                if (this.block) {
                  stats.native_signal_blocked++;
                  this.context.pc = stub;
                }
              }
            });
          } catch (e) {
            log("A2: hook " + name + " fail: " + e);
          }
        });
        ...
        Interceptor.attach(dlopen, {
          ...
          onLeave: function(retval) {
            if (this.path) {
              ...
              log("A4: dlopen_ext(" + tail + ") caller=" + this.caller + " ret=" + (retval.isNull() ? "NULL" : "ok"));
            }
          }
        });
        log("A4: android_dlopen_ext \u89C2\u5BDF\u5DF2\u88C5");
      })();
      log("B+C: scheduling Java.performNow/perform, available=" + (typeof frida_java_bridge_default !== "undefined" && frida_java_bridge_default ? frida_java_bridge_default.available : "NO-JAVA"));
      try {
        if (frida_java_bridge_default.performNow) frida_java_bridge_default.performNow(install_java_hooks);
        else frida_java_bridge_default.perform(install_java_hooks);
      } catch (e) {
        log("B+C: immediate Java hook failed: " + e);
        try {
          frida_java_bridge_default.perform(install_java_hooks);
        } catch (e2) {
          log("B+C: deferred Java hook failed: " + e2);
        }
      }
      live_emitted = {};
      live_scanning = false;
      ...
      rpc.exports = {
        ...
        loadedClassesCount: function() {
          var n = 0;
          frida_java_bridge_default.perform(function() {
            frida_java_bridge_default.enumerateLoadedClassesSync().forEach(function() {
              n++;
            });
          });
          return n;
        ...
        listLoadedClasses: function(prefix) {
          ...
          frida_java_bridge_default.perform(function() {
            frida_java_bridge_default.enumerateLoadedClassesSync().forEach(function(name) {
  ...
  // android/case-studies/imoutai/hooks/_build/entry.js
