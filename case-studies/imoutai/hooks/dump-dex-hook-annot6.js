...
`;
  ...
  // entry-annot6.js
  var require_entry_annot6 = __commonJS({
    "entry-annot6.js"() {
          ...
          safe(function() {
            ...
            MD.update.overloads.forEach(function(ov) {
              ov.implementation = function() {
                if (capturing) {
                  const rec = { kind: "update", sig: ov.argumentTypes.map(function(t) {
                    return t.className;
                  }).join(",") };
            ...
            MD.digest.overloads.forEach(function(ov) {
              ov.implementation = function() {
                ...
                if (capturing) {
                  const rec = { kind: "digest", sig: ov.argumentTypes.map(function(t) {
                    return t.className;
                  }).join(",") };
                  for (let i = 0; i < arguments.length; i++) {
                    const b = tryBytes(arguments[i]);
